...
def obtenerHoraCliente():
    ...
    horaCliente3 = getHoraCliente3()  # obtiene la hora del Cliente 3
    print("hora cliente 3: " + str(horaCliente2))
    diferenciacliente3 = calcularDiferencias(horaCliente3,
                                             horaServer)  # calcula diferencia del cliente con respecto al servidor
    horaAux = [horaCliente3[0], horaCliente3[1]]
    diferencias.append(diferenciacliente3)
    horas.append(str(horaCliente3))

    horaCliente4 = getHoraCliente4()  # obtiene la hora del Cliente 4
    print("hora cliente 4: " + str(horaCliente4))
    diferenciacliente4 = calcularDiferencias(horaCliente4,
                                             horaServer)  # calcula diferencia del cliente con respecto al servidor
    horaAux = [horaCliente4[0], horaCliente4[1]]
    diferencias.append(diferenciacliente4)
    horas.append(str(horaCliente4))

    horaCliente5 = getHoraCliente5()  # obtiene la hora del Cliente 5
    print("hora cliente 5: " + str(horaCliente5))
    diferenciacliente5 = calcularDiferencias(horaCliente5,
                                             horaServer)  # calcula diferencia del cliente con respecto al servidor
    horaAux = [horaCliente5[0], horaCliente5[1]]
    diferencias.append(diferenciacliente5)
    horas.append(str(horaCliente5))
